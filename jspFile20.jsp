...
<%-- 
	...
	4. session 객체 : 로그인, 로그아웃 즉 회원관리 회원인증프로그램 만들때 사용한다.
	5. application 객체 : 웹애플리케이션에 대한 정보를 저장할 때 사용한다.
	6. out객체 : 출력할 때 사용한다.
	7. config 객체 : jsp페이지에 대한 설정 정보를 저장할 때
	8. page : jsp페이지 구현할 때
	9. exception : 예외 에러 페이지 에서만 사용 

	실제적으로 웹개발에서 사용되는 jsp내장객체는 request,response,session,out까지 주로 사용하고, 가끔 가다가 application객체 등을 사용한다.
 --%>
 <h3>out 내장객체와 html_jsp서버 스크립트 코드가 혼합된 것과 jsp 스크립트 릿 코드만 사용한 것과의 차이점</h3>
