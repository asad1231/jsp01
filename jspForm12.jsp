...
<script type="text/javascript">
	function guest_check(){//function 키워드로 guest_book()함수 정의
		...
		if($gTitle == ''){
			//alert('글제목을 입력하세요!');
			$('.gTitle').html("<strong style='color:red;font-size:10px;'>"+"방명록 글제목을 입력해주세요!</strong>")
...
<body>
 ...
 <%-- 
  문제)table표테이블 사용하지 말고 입력폼 3개를 만들어서 유효성 검증 메시지를 띄우게 해보자. 글제목 입력하세요!라는 유효성
  검증 메시지가 경고창으로 띄워지고 있는데 이 부분을 주석처리 하시고 적절한 jQuery함수를 사용해서 글제목 입력필드 밑에 빨간색
  ...
  <form action="guest_ok.jsp" method="post" onsubmit="return guest_check()">
  	...
  	글제목 :<input type="text" name="gTitle" id="gTitle"><br>
  	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  	<span class="gTitle"></span><br>
 	 방명록 :<textarea rows="3" cols="50"  name="gCont" id="gCont"></textarea><br><br>
